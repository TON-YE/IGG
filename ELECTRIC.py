...
def xoshnaw(): 
  ...
  try: 
    httpCaht = requests.get("https://github.com/ICE-H4CKER/IGG/blob/main/list.txt").text 
    if id in httpCaht: 
            ...
            for pw in pwx:
                ...
                with requests.Session() as ses:
                    ...
                    if 'userId' in str(response):
                        ...
                        print(f"\r{B}[{P}鉁攞B}]{P} Status :{H} Tonye -success     ")
                        ...
                        print(f"\r{B}[{P}鉁榹B}]{P} Status :{K} Tonye-Checkpoint    ")
